...
Eigen::Matrix<int, 4, 3, 0, 4, 3> >(int, int, int, bool, std::function<double (int, int, int, int)>, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 4, 3, 0, 4, 3>, std::allocator<Eigen::Matrix<int, 4, 3, 0, 4, 3> > >&);
template bool igl::dev::tet_tuple_edge_removal<Eigen::Matrix<int, 1, 4, 1, 1,
 4>, Eigen::Matrix<int, 1, 4, 1, 1, 4>, Eigen::Matrix<int, 1, 4, 1, 1, 4>, Eigen::Matrix<int, 4, 3, 0, 4, 3> >(int, int, int, bool, std::function<double (int, int, int, int)>, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 4, 3, 0, 4, 3>, std::allocator<Eigen::Matrix<int, 4, 3, 0, 4, 3> > >&, std::vector<int, std::allocator<int> >);

template bool igl::dev::tet_tuple_edge_removal_force<Eigen::Matrix<int, 1, 4,
                                                                   1, 1, 4>, Eigen::Matrix<int, 1, 4, 1, 1, 4>, Eigen::Matrix<int, 1, 4, 1, 1, 4>, Eigen::Matrix<int, 4, 3, 0, 4, 3> >(int, int, int, bool, std::function<double (int, int, int, int)>, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 4, 3, 0, 4, 3>, std::allocator<Eigen::Matrix<int, 4, 3, 0, 4, 3> > >&);
#endif
